    ...
    Screen(
        top=bar.Bar(
            [
                ...
                left_triangle(foreground=colors.white2),
                widget.CPU(
                    format='  {load_percent}%',
                ...
                left_triangle(foreground=colors.white, background=colors.white2),
                widget.Memory(
                ...
                left_triangle(foreground=colors.white2, background=colors.white),
                widget.Volume(
                    # fmt='VOL: {}',
                    padding=2,
                ...
                left_triangle(foreground=colors.white3, background=colors.white2),
                widget.WidgetBox(
                    widgets = [
                        widget.Systray(
